...
class VendorProfile(models.Model):
    vendor_user_profile = models.OneToOneField(
        VendorUser, on_delete=models.CASCADE, related_name="v_profile"
    )
...
class CustomerProfile(models.Model):
    customer_user_profile = models.OneToOneField(
        CustomerUser, on_delete=models.CASCADE, related_name="c_profile"
    )
    ...
    customer_image = models.ImageField(
        null=True,
        blank=True,
        upload_to="customer_profile_pics",
    )
