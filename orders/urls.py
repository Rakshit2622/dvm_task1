...
urlpatterns = [
	...
	path('wishlist/add-to-cart/<int:pk>',order_views.move_to_cart,name='move_to_cart'),
	path('wishlist/',order_views.wishlist_list,name='wishlist_list'),
	path('wishlist/delete/<int:pk>',WishlistDeleteView.as_view(),name='wishlist_item_delete'),
